...
const RestDetails = () => {
  ...
  const { data: rest, loading, error } = useFetch(`${BASE_URL}/rests/${id}`);
        ...
        <Container>
          ...
          {!loading && !error && (
            <Row>
              <Col lg="8">
                <div className="rest__content">
                  ...
                  <div className="rest__info">
                    ...
                    <div className="rest__extra-details">
                      <span>
                  ...
                  <div className="rest__reviews mt-4">
              ...
              <Col lg="4">
                <Booking tour={rest} avgRating={avgRating} />
              </Col>
            </Row>
          )}
        </Container>
